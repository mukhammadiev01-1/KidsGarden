...
export class BoardArticleInput {
	...
	memberId?: ObjectId; // BoardArticleInput ni createBoardArticle da ham ishlatamiz, shuning uchun memberId ni ham kiritdik, lekin bu field frontend dan kelmaydi, backend da memberId ni authMember decorator orqali olamiz
}
